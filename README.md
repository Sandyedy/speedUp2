...
git branch -M main
git remote add origin git@github.com:Sandyedy/speedUp2.git
...
- [Tiny PHP File Manager https://github.com/Sandyedy/speedUp2.git with search and file editor
- [simple php filemanager]
@Sandyedy's untitled project
## Bug tracker
